<template>
  <section class="gardener-wrapper">
    <div class="row card_row">
      <h1 class="column h6 color_label">Garden Metrics</h1>
      ...
      <div class="column half_whole">
        <article class="card box_panel">
          ...
          <section class="card_body">
            <div class="graph">
              <div class="txt_success graph_data txt_serif">27</div>
            </div>
          </section>
          <section class="card_more">
            <div class="color_label card_more_content card_division">
